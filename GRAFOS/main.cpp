...
void menu() {
	...
	do {
		...
		cout << " [4] Recorrer en anchura " << endl;
		cout << " [5] Recorrer en profundidad " << endl;
		cout << " [6] Buscar un vertice o nodo " << endl;
		cout << " [7] Ver el grafo " << endl;
		...
		switch (opc)
		{
			...
			case 3:
				...
				break;
			case 4 :
				cout << " ----------- RECORRIDO EN ANCHURA  ----------" << endl <<endl << endl;
				if (grafo->grafoVacio()) {
					cout << "El grafo esta vacio" << endl << endl;
				}
				else {
			...
			case 5:
				...
				if (grafo->grafoVacio()) {
					...
					cout << "Ingrese el vertice origen " << endl;
					cin >> vecti;
					grafo->RecorridoProfundidad(vecti);
					cout << endl << endl;
				}
